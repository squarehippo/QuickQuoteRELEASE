...
class QuoteSheet: UIView {
    ...
    override init(frame: CGRect) {
       ...
       func setup() {
           Bundle.main.loadNibNamed("QuoteSheet", owner: self, options: nil)
